...
const GitHubProjects = () => {
    ...
    <section className="p-6 bg-[#FFF8F0] rounded-xl shadow-md">
      <h2 className="text-2xl font-bold text-purple-800 mb-4">Mis proyectos en GitHub 🚀</h2>
      <ul className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
        {repos.map((repo) => (
          <li
            key={repo.id}
            className="border border-purple-200 rounded-lg p-4 hover:shadow-lg transition-shadow bg-white"
          >
